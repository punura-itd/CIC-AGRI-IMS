...
import { X, Truck, Edit } from 'lucide-react';
...
const EditSupplierModal: React.FC<EditSupplierModalProps> = ({ isOpen, onClose, supplier, onSubmit }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-200 bg-gradient-to-r from-orange-50 to-amber-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-slate-800">Edit Supplier</h2>
              <p className="text-sm text-slate-600">Update supplier information</p>
            </div>
          </div>
          <button
            onClick={handleClose}
